...
上面这个公式怎么看都不对啊，这个公式的结果应该是

$$
\frac{\partial{z}}{\partial{b}}=\frac{\partial{z}}{\partial{x}} \cdot \frac{\partial{x}}{\partial{b}}+\frac{\partial{z}}{\partial{y}}\cdot\frac{\partial{y}}{\partial{b}}=2 \frac{\partial{z}}{\partial{b}}
$$

而这显然是错误的，如果它是对的，请作者详细解释
